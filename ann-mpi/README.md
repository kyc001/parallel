...
Both modes partition base vectors across MPI ranks, broadcast queries, search
...
IVF-PQ `(nlist=16,nprobe=4,p=1000)`, and block-HNSW `(m=16,ef=50)`.
The comparison table is saved in `results/cross_platform_summary.txt`.
